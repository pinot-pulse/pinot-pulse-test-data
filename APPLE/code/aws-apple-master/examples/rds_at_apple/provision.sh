...
function usage() {
    ...
    echo " -i, --instance-type              Instance Type (default: db.t3.small)"
    echo " -s, --storage-size               The amount in GB of storage on the RDS instance (default: 100)"
...
# Launch the RDS stack
echo "NOTE: RDS is going to take FOREVER (ok, maybe 15 minutes) to spin up..."
